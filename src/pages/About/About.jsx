      ...
      <div className="mx-auto min-h-[100vh] lg:min-h-[74vh] w-[] flex gap-5 flex-col  lg:flex-row px- lg:px items-center justify-between ">
        <div className=" h-[50vh] md:h-[60vh] w-[100%] flex flex-col items-start justify-center gap-3 md:gap-10 px-10 bg-darkBlue rounded-3xl md:flex-1 shadow-lg">
          <h1 className=" text-xl font-bold ">
            ...
            <span className="text-textOrange">excellence.</span>
          </h1>
          <p className="lg:text-sm text-justify">
            At Uloma Estate Ltd, our mission is to provive comprehensive
            property management solutions that empower landlords and businesses
            to manage their properties and tenants. We are committed to
            delivering personalized services that prioritize the needs of our
            clients.
          </p>
          <button className="btn bg-textOrange text-white border-none outline-none shadow-lg">
            {" "}
            Create Account
          </button>
      ...
      <div className=" mx-auto p-10  bg-lightBlue flex flex-col gap-5 items-start justify-start lg:gap-10 ">
        <div className="mx-auto flex flex-col lg:w-[100%] items-start justify-center lg:justify-start self-start  box-border">
          ...
          <p className="lg:w-[50%] text-xl text-justify">
            ...
            commitment to the satisfaction and community development
          </p>
        </div>
        <div className="mx-auto lg:min-h-[50vh] lg:px-20 flex flex-col gap-10 lg:flex-row flex-1 w-full">
          <div className=" picture mission h-[60vh] lg:flex-1 flex items-center justify-center lg:h-[50vh] w-full border-2 border-solid border-textOrange shadow-lg rounded-3xl"></div>
          <div className="flex flex-col flex-1 items-start justify-center">
            ...
            <p className="text-xl text-justify">
              ...
              a strong commitment to the satisfaction and community development
            </p>
          </div>
        </div>
        <div className="flex gap-10 flex-col lg:flex-row items-center justify-center lg:px-20">
          <div className="flex flex-col flex-1 items-start justify-center">
            <h1 className="text-textOrange font-bold text-2xl">Vision</h1>
            <p className="text-xl text-justify">
              Our vision in Uloma is to redefing property management by creating
              a seamless and personalized experience for Landlords and tenants
              alike. We envision a future where property management is
              assessible, transparent and tailored to individual preferences.{" "}
              <br /> <br /> Through continuous innovation and collaboration, we
              strive to be at the forefront of the industry, setting new
              standards for customer-centric property management. Our vision is
              to be the prefered property agency known for unwavering
      ...
      <div className="mx-auto h-[170vh] px-10 lg:mt-20 lg:px-20 property-management w-full flex-col md:flex-row gap-10 lg:gap-2 items-start justify-start lg:flex-row">
        <div className="mx-auto flex bg-darkBlue h-[80vh] w-full flex-col items-center justify-start p-10 lg:w-full gap-10 lg:gap-1 rounded-tl-3xl rounded-br-3xl shadow-lg border-4 border-solid border-textOrange">
          ...
          <p className="text-justify text-md lg:text-xl">
            Our automated systems help you as a landlord to manage your property
            in such a way that you are provided details of all information
            concerning your tenants. <br /> <br /> These details include: name,
            address, floor, exact position of their rented appartments, the rent
            tenure, renewal date with expiry date too. Our systems send out
            reminders to your tenants and also to you the property owner to be
            aware of the rent due date and expiry date too. <br /> <br /> Our
            systems will ask tenants if they are widlling to renew the rent so
            as to enable you to offer the property to other interested tenants.
            The system will also list the space for the time the current tenant
            will be out of the property so that other intending tenants can
            apply ahead of time for space reservation with a minimal fee. .
          </p>
