        ...
        <div className="mx-auto min-h-[100vh] lg:min-h-[74vh] w-[] flex gap-5 flex-col  lg:flex-row px- lg:px items-center justify-between ">
          <div className=" h-[50vh] md:h-[60vh] w-[100%] flex flex-col items-start justify-center gap-3 md:gap-10 px-10 bg-darkBlue rounded-3xl md:flex-1 shadow-lg">
            ...
            <p className="lg:text-sm text-justify">
              ...
              committed to delivering personalized services that prioritize the
          ...
          <div className="mx-auto lg:min-h-[50vh] lg:px-20 flex flex-col gap-10 lg:flex-row flex-1 w-full">
            ...
            <div className="flex flex-col flex-1 items-start justify-center">
              ...
              <p className="text-xl text-justify">
                ...
                maintaining a strong commitment to the satisfaction and
        ...
        <div className="mx-auto h-[170vh] px-10 lg:mt-20 lg:px-20 property-management w-full flex-col md:flex-row gap-10 lg:gap-2 items-start justify-start lg:flex-row">
          <div className="mx-auto flex bg-darkBlue h-[80vh] w-full flex-col items-center justify-start p-10 lg:w-full gap-10 lg:gap-1 rounded-tl-3xl rounded-br-3xl shadow-lg border-4 border-solid border-textOrange">
            ...
            <p className="text-justify text-md lg:text-xl">
              Our automated systems help you as a landlord to manage your
              property in such a way that you are provided details of all
              information concerning your tenants. <br /> <br /> These details
              include: name, address, floor, exact position of their rented
              appartments, the rent tenure, renewal date with expiry date too.
              Our systems send out reminders to your tenants and also to you the
              property owner to be aware of the rent due date and expiry date
              too. <br /> <br /> Our systems will ask tenants if they are
              widlling to renew the rent so as to enable you to offer the
              property to other interested tenants. The system will also list
              the space for the time the current tenant will be out of the
              property so that other intending tenants can apply ahead of time
