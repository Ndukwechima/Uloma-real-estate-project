...
const Header = () => {
  return (
    <div className="mx-auto h-[10vh] lg:h-[20vh] bg-darkBlue flex items-center justify-center z-50 fixed right-0 left-0 top-0">
        ...
        <div className="flex-1 flex items-center gap-10 px-2 justify-start">
          ...
          <form className="hidden md:flex items-center justify-between gap-4 bg-white  rounded-3xl px-5  box-border w-96">
            <input
              ...
              className="flex- py-2  px- border-none outline-none bg-white w-full"
            />
        ...
        <div className="flex-1 lg:h-[10vh] mx-auto  gap-2 items-center justify-end">
          ...
          <ul className="hidden lg:h-[10vh] lg:flex lg:items-center lg:justify-center">
            <li className="lg:h-[10vh] flex items-center justify-center hover:opacity-90 bg-darkBlue">
              <NavLink
                to={"/"}
                className="nav lg:h-[10vh] flex justify-center items-center w-[100%] p-3 "
              >
                Home
              </NavLink>
            </li>
            <li className=" lg:h-[10vh] p-3 flex items-center justify-center">
              <NavLink
                to={"/About"}
                className="nav lg:h-[10vh] flex justify-center items-center w-[100%] p-3"
              >
            ...
            <li className="lg:h-[10vh] p-3 flex items-center justify-center ">
              <NavLink
                to={"/Signup"}
                className="nav lg:h-[10vh] flex justify-center items-center w-[100%] p-3 min-w-[100px]"
              >
                Sign Up
              </NavLink>
            </li>
            <li className="lg:h-[10vh] p-3 flex items-center justify-center ">
              <NavLink
                to={"/Login"}
                className="nav lg:h-[10vh] flex justify-center items-center w-[100%] p-2 min-w-[80px]"
              >
                Log In
              </NavLink>
            </li>
